...
public class AppConfiguration {
    ...
    @Autowired
    private Environment environment;//1-application.properties dosyanın içindeki değişkenler ve
                                    //2- uygulamanın çalıştığı tüm ortam(sistem) değişkenlerine ulaşmak için
    ...
    //value annotationı ile yaptığımızı properties classı ile de yapabiliriz.
