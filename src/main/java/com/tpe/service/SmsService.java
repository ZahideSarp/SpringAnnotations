...
public class SmsService implements MessageService{
    ...
    @PostConstruct//classın constructor'ı çağrıldıktan hemen sonra bu metodun çağırılması icin
    public void init(){
    ...
    public void printContact(){//ilestisim bilgilerini yazdiran bir methodum var
...
//        System.out.println("phone number: 0123456789");
    ...
    public void printProperties(){
        System.out.println("contact email :"+properties.get("mymail"));//getproperty() methodu ile de yapabiliriz.
